...
///
/// This component should be attached to the spawned entity. In the case that frame components are
/// attached to separate child entities of a game object, this should point to the main game object
/// entity.
