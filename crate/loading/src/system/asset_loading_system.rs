...
impl<'s> System<'s> for AssetLoadingSystem {
    ...
    fn run(
        ...
        } = &mut asset_loading_resources.id_mapping_resources;
...
impl AssetLoadingSystem {
        ...
        match load_status {
            ...
            LoadStatus::DefinitionLoading => {
                if Self::definition_loaded(asset_loading_resources, asset_id) {
                    Self::id_map(asset_loading_resources, asset_id);

                    LoadStatus::IdMapping
                } else {
                    LoadStatus::DefinitionLoading
                }
            }
            LoadStatus::IdMapping => {
                if Self::id_mapped(asset_loading_resources, asset_id) {
    ...
    fn id_mapped(asset_loading_resources: &AssetLoadingResources, asset_id: AssetId) -> bool {
