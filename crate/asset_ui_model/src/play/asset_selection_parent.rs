...
/// Links a child entity to a parent entity that has an `AssetSelection`
/// component.
///
/// This component should be attached to the child entity.
///
/// This will allow the child entity to display a sprite sequence depending on
/// the parent's `AssetSelection`.
