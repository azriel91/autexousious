...
mod tests {
    ...
    use sequence_model::config::{
        ControlTransition, ControlTransitionSingle, TickTransition, Wait,
    };
    ...
    fn sequence_with_empty_frames_list_deserializes_successfully() {
        ...
        let expected = CharacterSequence::new(ObjectSequence::new(TickTransition::None, vec![]));
    ...
    fn sequence_with_control_transitions() {
        ...
        let expected = CharacterSequence::new(ObjectSequence::new(TickTransition::None, frames));
