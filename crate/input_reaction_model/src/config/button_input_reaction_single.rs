...
/// Variants of how a `ButtonInputReactionSingle` may be specified.
///
/// This is primarily to make it more ergonomic for users to specify different kinds of values in
/// configuration.
#[derive(Clone, Debug, Deserialize, PartialEq, Serialize, new)]
#[serde(rename_all = "snake_case")]
pub struct ButtonInputReactionSingle<SeqName, IRR>
where
...
impl<SeqName, IRR> AsRef<InputReaction<SeqName, IRR>> for ButtonInputReactionSingle<SeqName, IRR>
where
    SeqName: SequenceName,
    IRR: Default,
{
