...
///
/// This is for reacting to device (keyboard, mouse, etc.) buttons as opposed to `ControlButton`s.
/// Typically used for UIs for configuring the application, rather than setting up a game.
