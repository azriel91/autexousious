pub use self::character_component_storages::CharacterComponentStorages;
pub use self::character_entity_spawner::CharacterEntitySpawner;
...
pub use self::object_animation_storages::{
