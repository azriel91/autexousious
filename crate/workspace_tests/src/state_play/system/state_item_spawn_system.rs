...
mod tests {
    ...
    use state_play::{StateItemSpawnSystem, StateItemSpawnSystemData};
    ...
    #[test]
    fn spawns_item_entities_when_event_sent() -> Result<(), Error> {
        run_test(
            SetupParams {
    ...
    #[test]
    fn deletes_previous_item_entities_when_event_sent() -> Result<(), Error> {
        run_test(
            SetupParams {
                events: vec![StateIdUpdateEvent::new(StateId::CharacterSelection, None)],
    ...
    #[test]
    fn deletes_previous_item_entities_when_next_state_id_has_no_assets() -> Result<(), Error> {
        run_test(
            SetupParams {
                events: vec![StateIdUpdateEvent::new(StateId::CharacterSelection, None)],
                events_next: vec![StateIdUpdateEvent::new(
    ...
    fn assert_background_entity_count(world: &mut World, entity_count: usize) {
        let item_ids = world.read_storage::<ItemId>();

        assert_eq!(entity_count, item_ids.count());
    }
