...
//!
//! Amethyst does not yet support custom event types for `State`s to handle. This is a workaround.
//!
//! # Development
//!
...
//!
//! > We didn't reach any consensus on such user-made events yet. The current event types are just
//! > reexport of winit types, which we intend to replace.
//!
//! See:
//!
